...
public final class BookmarkHighlighting extends ZLTextSimpleHighlighting {
	...
	private static ZLTextPosition startPosition(Bookmark bookmark) {
		return new ZLTextFixedPosition(bookmark.getParagraphIndex(),
				bookmark.getElementIndex(), 0);
	}
	...
	public BookmarkHighlighting(ZLTextView view, IBookCollection collection,
			Bookmark bookmark) {
	...
	public ZLColor getBackgroundColor() {
		final HighlightingStyle bmStyle = Collection
				.getHighlightingStyle(Bookmark.getStyleId());
