...
public final class Constants {
     ...
     * 推荐-图文精装作品(查看全部)
     */
    public static final String PAGE_RECOMMEND_EPUB = "pageRecommendepub";
    /**
     * 推荐-明星作家界面(查看全部).
     */
    public static final String PAGE_RECOMMEND_STARAUTHORS = "pageRecommendStarAuthors";
    /**
     * 推荐-明星作家作品列表界面(查看全部).
     */
    public static final String PAGE_RECOMMEND_AUTHORBOOKS = "pageRecommendAuthorBooks";
    /**
     * 推荐-名人推荐界面(查看全部).
     */
     ...
     * 精选-男生爱看-查看全部.
     */
    public static final String CLICK_RECOMMEND_BOY_LIKE = "clickRecommendBoyLike";
    /**
     * 精选-女生爱看查看全部.
     */
    public static final String CLICK_RECOMMEND_GIRL_LIKE = "clickRecommendGirlLike";
    /**
     * 推荐-点击分类.
     */
     ...
     * 推荐-点击图文精品.
     */
    public static final String CLICK_RECOMMEND_EPUB = "clickRecommendEpub";
    /**
     * 推荐-点击明星作家.
     */
    public static final String CLICK_RECOMMEND_STARAUTHOR = "clickRecommendStarAuthor";
    /**
     * 推荐-点击和阅读.
     */
     ...
     * 个人中心-进入选你喜欢界面.
     * <ul>
     * <li>注：选你喜欢页面，选择的分类类型统计形式为：分类关键字+"Like"作为新的关键字统计。
     * </ul>
     */
    ...
    /**
     * 阅读页-阅读书籍类型(1-免费，2-整本收费，3-章节收费, 4-APPSTORE).
     */
    public static final String KEY_READ_BOOK_PAY_TYPE = "keyReadBookPayType#";
    /**
     * 阅读页-阅读书籍来源(sina-自己服务器，vdisk-微盘书，sdcard-本地导入).
     */
