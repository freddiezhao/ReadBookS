...
/**
 * 修改AsyncTask，修改线程池大小 《下载异步任务线程池》
 * 
 * @author Tsimle
 * 
 * @param <Result>
 */
public abstract class AbsDownloadAsyncTask<Params, Progress, Result> implements ICancelable{
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "DownTask #" + mCount.getAndIncrement());
        }
    };
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler
                            .obtainMessage(MESSAGE_POST_CANCEL,
                                    new AsyncTaskResult<Result>(
                                            AbsDownloadAsyncTask.this,
                                            (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskResult<Result>(AbsDownloadAsyncTask.this,
                                result));
                message.sendToTarget();
            }
        };
     ...
     */
    public final AbsDownloadAsyncTask<Params, Progress, Result> execute(
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final AbsDownloadAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(AbsDownloadAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
