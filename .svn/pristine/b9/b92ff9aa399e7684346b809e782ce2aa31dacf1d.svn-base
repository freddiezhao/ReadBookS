...
abstract class BookModelImpl extends BookModel
{
	...
	/**
	 * 以epub资源为例，id值是epub资源内的图片路径，如OEBPS/Images/cover.jpg，image则是一个ZLFileImage对象
	 */
	...
	// 由NativeFormatPlugin:readModel() -> readModelNative()
	// 从底层调用该方法，会依次将资源内的所有图像资源加载到myImageMap中
