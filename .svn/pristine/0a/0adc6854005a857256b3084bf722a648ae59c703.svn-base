...
public abstract class ZLArchiveEntryFile extends ZLFile
{
	...
	/**
	 * 例如Path为：/storage/emulated/0/Download/南方周末20140103_4717491b.epub.epub:
	 * OEBPS / Images/image030.jpeg
	 * 
	 * @param archive
	 *            代表/storage/emulated/0/Download/南方周末20140103_4717491b.epub.epub
	 * @param entryName
	 *            代表OEBPS/Images/image030.jpeg
	 * @return
	 */
	...
	{
		// 如：/storage/emulated/0/Download/南方周末.epub.epub:OEBPS/
		// Images/image030.jpeg
