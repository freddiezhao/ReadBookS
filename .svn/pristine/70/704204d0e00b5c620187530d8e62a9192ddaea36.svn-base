...
public final class ZLImageEntry {
	private final Map<String,ZLImage> myImageMap;// 所有图片数据Map，key为ZLImageEntry.Id
	public final String Id;// 路径，如OEBPS/Images/cover.jpg
	public final short VOffset;
	public final boolean IsCover;// 是否是封面图片
