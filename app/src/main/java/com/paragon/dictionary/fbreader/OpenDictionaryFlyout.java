...
public class OpenDictionaryFlyout
{
	...
	private Dictionary getDictionary(final Context context)
	{
		...
		ZLog.e(ZLog.FBReader, "OpenDictionaryFlyout:getDictionary - Dictionary with direction [" +
	...
	{
		ZLog.d(ZLog.FBReader, "OpenDictionaryFlyout:showTranslation");
		final Dictionary dictionary = getDictionary(activity);
		if (dictionary == null) {
			ZLog.e(ZLog.FBReader, "OpenDictionaryFlyout:showTranslation - null dictionary received");
			return;
		}
