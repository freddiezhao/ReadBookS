...
public abstract class AbsImageAsyncTask<Params, Result> {
    ...
    private static final ThreadPoolExecutor sExecutor = new ThreadPoolExecutor(
            ...
            sWorkQueue, sThreadFactory, new DiscardAndRemoveOldestPolicy());
        ...
        mFuture = new WrappedFutureTask<Params, Result>(mWorker, this) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    LogUtil.w(LOG_TAG, "Interrupted ", e);
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new ImageBaseTaskResult<Result>(
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new ImageBaseTaskResult<Result>(AbsImageAsyncTask.this,
                                result));
                message.sendToTarget();
            }
        };
    ...
    private static class DiscardAndRemoveOldestPolicy implements
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor e) {
            if (!e.isShutdown()) {
                AbsImageAsyncTask<?, ?> discardTask = ((WrappedFutureTask<?, ?>) e
                        .getQueue().poll()).originTask;
                Message message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                        new ImageBaseTaskResult<String>(discardTask,
                                (String[]) null));
                message.sendToTarget();
                e.execute(r);
            }
    ...
    private static class WrappedFutureTask<Params, Result> extends
            FutureTask<Result> {
