...
class SyncNetworkContext extends ServiceNetworkContext {
	...
	SyncNetworkContext(Service service, SyncOptions syncOptions,
			ZLEnumOption<SyncOptions.Condition> featureOption) {
		super(service);
	...
	private ConnectivityManager getConnectivityManager() {
		if (myConnectivityManager == null) {
			myConnectivityManager = (ConnectivityManager) getContext()
