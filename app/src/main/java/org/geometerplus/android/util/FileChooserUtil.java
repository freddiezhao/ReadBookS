...
public abstract class FileChooserUtil {
	...
	public static void runFileChooser(Activity activity, int requestCode,
			String title, String initialDir, String regexp) {
//		final Intent intent = new Intent(activity, FileChooserActivity.class);
//		intent.putExtra(FileChooserActivity._TextResources,
//				textResources(title));
//		intent.putExtra(FileChooserActivity._Rootpath,
//				(Parcelable) new LocalFile(initialDir));
...
//		activity.startActivityForResult(intent, requestCode);
	...
	public static void runDirectoryChooser(Activity activity, int requestCode,
			String title, String initialValue, boolean chooseWritableDirsOnly) {
//		final Intent intent = new Intent(activity, FileChooserActivity.class);
//		intent.putExtra(FileChooserActivity._TextResources,
//				textResources(title));
//		intent.putExtra(FileChooserActivity._Rootpath,
//				(Parcelable) new LocalFile(initialValue));
//		intent.putExtra(FileChooserActivity._ActionBar, true);
//		intent.putExtra(FileChooserActivity._SaveLastLocation, false);
//		intent.putExtra(FileChooserActivity._DisplayHiddenFiles, true);
//		intent.putExtra(
//				FileChooserActivity._FilterMode,
//				chooseWritableDirsOnly ? IFileProvider.FilterMode.DirectoriesOnly
...
//
	public static List<String> filePathsFromData(Intent data) {
		return null;
//		final List<IFile> files = data
//				.getParcelableArrayListExtra(FileChooserActivity._Results);
...
//		return paths;
	...
	private static HashMap<String, String> textResources(String title) {
		...
		map.put("folderNameHint", resource.getResource("folderNameHint")
				.getValue());
		...
		map.put("permissionDenied", resource.getResource("permissionDenied")
				.getValue());
